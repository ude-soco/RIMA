      ...
      .then((json) => {
        ...
        for (let i = 0; i < json.data.length; i++) {
          series = series.concat([
            { name: selectedValues[i], data: json.data[i] },
          ]);
        }
        this.setState({
          active1: false,
          ...
          options: {
            ...this.state.options,
            xaxis: { ...this.state.options.xaxis, categories: json.years },
          },
        });
      });
  };
      ...
      <div id="chart" className="box">
        <Form role="form" method="POST">
          <FormGroup>
            ...
            <p>
              The evolution of the most popular five topics and keywords of a
              conference.
            </p>
            <br></br>
            <Button
            ...
            {this.state.imageTooltipOpen && (
              ...
              >
                <p>
                  {" "}
                  The evolution of the top five topics/keywords in the last 5
                  years of a selected conference.
                </p>
              </div>
            )}
          </FormGroup>
