...
class TextHighlighter(object):
            ...
            if n_gram_word_list:
                ...
                if len(n_gram_word_list[0].split(' ')) == 1:
                    ...
                    if kw_list.index(min_score_word) == 0:
                        ...
                        index_of_more_relevant = splited_n_gram_kw_list[
                            0].index(min_score_word.split()[0])
                        temporal_kw = ' '.join(
                        ...
                        if temporal_kw.lower() in relevant_words_array:
                            ...
                            for tmp_kw in splited_n_gram_kw_list[
                                    0][:index_of_more_relevant]:
    ...
    def find_more_relevant(
        ...
        n_gram_word_list = sorted(temporary_list_two,
                                  key=lambda x: relevant_words_array.index(x))
