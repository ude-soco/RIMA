...
class CompareStackedBarChart extends Component {
  ...
  selectYearsRange = (e) => {
    fetch(`${BASE_URL_CONFERENCE}/api/conferences/` + "getSharedYears/?" + this.state.selectedConferences.join("&"))
  ...
  selectSharedWords = (val) => {
    fetch(`${BASE_URL_CONFERENCE}/api/conferences/` + "getSharedWordsBar/" + val + "/" + this.state.selectValue.value + "/?" + this.state.selectedConferences.join("&"))
      .then((response) => response.json())
      .then((json) => {
        var series = [];
  ...
  selectSharedKeywords = (e) => {
    fetch(`${BASE_URL_CONFERENCE}/api/conferences/` + "getSharedWordsBar/keyword/" + this.state.selectValue.value + "/?" + this.state.selectedConferences.join("&"))
      .then((response) => response.json())
      .then((json) => {
        var series = [];
        console.log(json.Topiclist[0]);
