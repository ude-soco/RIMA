      ...
      >
        <Grid container xs={12}>
          <Typography
            ...
            gutterBottom
          >
            Comparing the Evolution of Co-Authorship Among Authors Over the
            Years
          </Typography>
          <Grid container xs={12}>
            <Typography variant="h6">
              This line chart visualizes the evolution of each author's
              co-authorship relationships over the years. Each line represents a
              specific author, tracking the count of their co-authors on a
              year-by-year basis.
            </Typography>
          </Grid>
        </Grid>
...
export default CoauthorEvolution;
