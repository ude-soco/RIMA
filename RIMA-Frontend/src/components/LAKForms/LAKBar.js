...
import { Button, Label, FormGroup, Form,ButtonGroup,Row,Col } from "reactstrap";
...
class LAKBar extends Component {
  ...
  displayDocChart(topic,year){
    var selectyear="2011"
    fetch("http://127.0.0.1:8000/api/interests/topicdetails/"+topic+"/"+year)
      ...
      this.setState({
        ...
        options: {
          ...
          chart: {
            ...
            events:{
              dataPointSelection: function(event, chartContext, config) {
                var topic=config.w.config.xaxis.categories[config.dataPointIndex]
  ...
  selectKeyword(e){
    ...
    fetch("http://127.0.0.1:8000/api/interests/topkeywords/"+this.state.selectyear)
    .then((response) => response.json())
    .then((json) => {
  ...
  selectValue(e){
    const display=this.displayDocChart
    var year=this.state.selectyear
    fetch("http://127.0.0.1:8000/api/interests/toptopics/"+this.state.selectyear)
    .then((response) => response.json())
    .then((json) => {
        ...
        <>
          ...
          <Form role="form">
            <FormGroup>
              ...
              <p>The bar chart displays the top 10 topics/keywords for the selected year and its corresponding publications</p>
       ...
       onMouseOut={() => this.handleToogle(false)}
        ...
        ></i> 
         {this.state.imageTooltipOpen && (
                            ...
                            >
                            <p>The charts are displayed based on the frequency of topic/keyword</p>
