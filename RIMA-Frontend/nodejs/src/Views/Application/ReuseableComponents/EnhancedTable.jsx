...
function createData(text, firstPapercount, secondPaperCount) {
  return {
    text,
    firstPapercount,
    secondPaperCount,
...
const rows = [
  createData("Learning", 30, 50),
  createData("Data", 452, 250),
  createData("AI", 262, 164),
  createData("Analysis", 159, 600),
];
...
const headCells = [
  {
    ...
    numeric: false,
    disablePadding: true,
    label: "Common keywords/ topics",
  },
  {
    id: "firstPapercount",
    numeric: true,
    disablePadding: false,
    label: "Occurance in first paper",
  },
  {
    id: "secondPaperCount",
    numeric: true,
    disablePadding: false,
    label: "Occurance in second paper",
  },
];
  ...
  return (
    ...
    >
      ...
      {numSelected > 0 ? (
        ...
        <Tooltip title="Click on occurance to resort table">
          <IconButton>
            <FilterListIcon />
          </IconButton>
        </Tooltip>
              ...
              {visibleRows.map((row, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <TableCell align="right">{row.firstPapercount}</TableCell>
                    <TableCell align="right">{row.secondPaperCount}</TableCell>
                  </TableRow>
                );
              })}
              {emptyRows > 0 && (
