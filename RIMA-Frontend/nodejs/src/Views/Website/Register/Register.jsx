              ...
              <Grid item xs={12} sm={6}>
                ...
                >
                  ...
                  >
                    <Grid item xs>
                      <Typography>
                        Semantic Scholar ID is used to get your paper
                        information.
                        <br />
              ...
              <Grid item xs={12} sm={6}>
                ...
                <Grid container justifyContent="flex-end">
                  <Button
                    ...
                    onClick={handleHelper}
                  >
                    <Typography variant="body2">Twitter ID?</Typography>
                  </Button>
                </Grid>
                <Popover
                ...
                >
                  ...
                  >
                    <Grid item xs>
                      <Typography>
                        Twitter username is used to get your tweets information.
                        <br />
                        Open
                        ...
                        and get your username 'e.g. @username'.
                      </Typography>
                    </Grid>
                    <Grid item>
                      <IconButton
