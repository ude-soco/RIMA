                  ...
                  <Row className="align-items-center">
                    ...
                    >
                      <div>
                        ...
                        <p> This chart shows your interests, which are extracted from your papers, tweets, or manually added keywords.
                          <p className="flex">You can learn more about why/how this chart was generated by: </p>
                          <li> hovering over a keyword (basic)</li>
                          <li> clicking on a keyword (intermediate) </li>
                          <li> clicking
                            <span onClick={this.modalDetail} style={{marginLeft: "4px", marginRight: "4px", color: "blue", cursor: "pointer"}}>
                               here
                            </span>
                            (advanced) &nbsp;
                          </li>
                        ...
                        <div>
                          ...
                          {this.state.tooltipOpen && (
                            ...
                            >
                              ...
                              results, click 'Manage Interests' to generate a better interest
                              model yourself.
                            </div>
                          )}
                        </div>
