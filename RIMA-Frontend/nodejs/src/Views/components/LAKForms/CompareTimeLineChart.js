...
class CompareTimeLineChart extends React.Component {
  ...
  selectData = (val) => {
    fetch(`${BASE_URL_CONFERENCE}/api/conferences/` + "getDataTimeLineChart/" + val + "/?" + this.state.selectedConferences.join("&"))
  ...
  selectKeywordsData = (e) => {
    fetch(`${BASE_URL_CONFERENCE}/api/conferences/` + "getDataTimeLineChart/keyword/?" + this.state.selectedConferences.join("&"))
      .then((response) => response.json())
      .then((json) => {
