(function(undefined) {
  ...
  var drawImg = function(node, x, y, size, context) {
    let img = new window.Image();
    img.addEventListener("load", function() {
      context.drawImage(img, x, y);
    });
    img.clip = 0.7;
    img.setAttribute("src", "https://www.gravatar.com/avatar/HASH");
    console.log(img, "img");
    //context.drawImage("https://www.gravatar.com/avatar/HASH", 10, 10);
  };
