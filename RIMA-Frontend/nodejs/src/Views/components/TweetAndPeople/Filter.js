...
import { MdFormatQuote, MdKeyboardArrowDown, MdKeyboardArrowUp, MdLocationOn, MdFavoriteBorder } from "react-icons/md";
import Map from "./Map";
  ...
  render() {
    ...
    const content = (
      <div className="p-0 m-0">
        <div className="form-group row p-0 m-0">
          <label
            className="col-3 col-form-label p-0 mx-1 my-auto"
            htmlFor={"type" + content_id}
          >
            <small>Showing</small>
          </label>
      ...
      <div className="p-0 m-0">
        ...
        <div className="form-group row p-0 m-0">
          ...
          <input
            ...
            className="col-2 p-0 mx-0 my-1"
            id={"rad" + location_id}
            name={"rad" + location_id}
            value={this.state.radius}
            onChange={(e) => this.onChange("radius", e.target.value)}
          />
          <label
            className="col-1 col-form-label p-0 mx-1 my-auto"
            htmlFor={"rad" + location_id}
    ...
    const engagement = (
      <div className="p-0 m-0">
        <div className="form-group row p-0 m-0">
          ...
          />
          <div className="col-1 p-0 mx-0 my-1"></div>
    ...
    return (
      <div id={"accordion" + id_}>
        <div className="card">
          <div className="card-header p-0" id={"h1" + content_id}>
            <div>
              <a
                ...
                href={"#" + content_id}
              >
                <MdFormatQuote className="float-left my-auto" />
                <div className="ml-2 float-left my-auto">Tweet content</div>
                <MdKeyboardArrowDown className="chev-d float-right my-auto" />
                <MdKeyboardArrowUp className="chev-u float-right my-auto" />
              </a>
            </div>
          </div>
          <div
            className="collapse p-0 m-0"
            data-parent={"#accordion" + id_}
            id={content_id}
          >
            <div className="card-body p-0 m-0">{content}</div>
          </div>
        </div>
        <div className="card">
          <div className="card-header p-0" id={"h1" + location_id}>
            <div>
              <a
                className="collapsed card-link"
                data-toggle="collapse"
                ...
                href={"#" + location_id}
              >
                <MdLocationOn className="float-left  my-auto" />
          ...
          <div
            ...
            id={location_id}
          >
            <div className="card-body p-0 m-0">{location}</div>
          </div>
        </div>
        <div className="card">
          <div className="card-header p-0" id={"h1" + engagement_id}>
            <div>
              <a
                className="collapsed card-link"
                data-toggle="collapse"
                ...
                href={"#" + engagement_id}
              >
                <MdFavoriteBorder className="float-left my-auto" />
          ...
          <div
            ...
            id={engagement_id}
          >
            <div className="card-body p-0 m-0">{engagement}</div>
          </div>
        </div>
      </div>
    );
