...
class ConferenceEventPaperSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = ['paper_id', 'paper_doi', 'title', 'url', 'year',
                  'abstract', 'no_of_cititations', 'citiations', 'paper_venu']
...
class ConferenceEventSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['conference_event_name_abbr',
                  'conference_event_url', 'no_of_stored_papers']

    # def create(self, validated_data):
    #     # papers_data = validated_data.pop('conference_event_papers')
    #     # event = Conference_Event.objects.create(**validated_data)
    #     # for paper_data in papers_data:
    #     #     Conference_Event_Paper.objects.create(
    #     #         conference_event_name_abbr=event, **paper_data)
...
class ConferenceSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Conference
        fields = ['conference_name_abbr',
                  'conference_url', 'conference_events']
    ...
    def create(self, validated_data):
        ...
        for conference_data in conferences_data:
            Conference.objects.create(
                platform_name=platform, **conference_data)
        return platform
